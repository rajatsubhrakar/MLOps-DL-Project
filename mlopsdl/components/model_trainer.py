...
from mlopsdl.utils.main_utils import load_numpy_array, read_yaml_file, load_object, save_object
from mlopsdl.entity.config_entity import ModelTrainerConfig
from mlopsdl.entity.artifact_entity import DataTransformationArtifact, ModelTrainerArtifact, ClassificationMetricArtifact
...
class ModelTrainer:
    ...
    def initiate_model_trainer(self, ) -> ModelTrainerArtifact:
        ...
        try:
            ...
            mlopsdl_model = MLOpsDLModel(preprocessing_object=preprocessing_obj,
                                          trained_model_object=best_model_detail.best_model)
            logging.info("Created MLOpsDL model object with preprocessor and model")
            logging.info("Created best model file path.")
            save_object(self.model_trainer_config.trained_model_file_path, mlopsdl_model)
